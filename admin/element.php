...
<div class="container-fluid position-relative d-flex p-0" >
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4 flex-grow-1">
                <div class="create">
                    <a href="/Eu/Practica/admin/accounts_crud/create.php" style='display:flex;'>
                        <div class="icon">
                ...
                <div class="row g-4">
                    <?php
                        ...
                        $sql = mysqli_query($conexiune, "SELECT * FROM `logs`");
                        ...
                        if (mysqli_num_rows($sql) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($sql)) {
                                ...
                                echo "<td>$rootText</td>";
                                echo "<td>";
                                echo "<a href='/Eu/Practica/admin/accounts_crud/delete.php?id=$logId'><span class='material-symbols-outlined' style='margin-left: 10px;'>delete</span></a>";
                                echo "<a href='/Eu/Practica/admin/accounts_crud/update.php?id=$logId'><span class='material-symbols-outlined' style='margin-left: 10px;'>update</span></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
            ...
            <div class="container-fluid pt-4 px-4 mt-auto" style='position: fixed;bottom:0;'>
