...
<body>
    <div class="container-fluid position-relative d-flex flex-column p-0">
        <!-- Spinner Start -->
        ...
        <div class="content flex-grow-1">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="create">
                    <a href="/Eu/Practica/admin/products_crud/create.php" style='display:flex;'>
                        <div class="icon">
                    ...
                    <?php
                        ...
                        if (mysqli_num_rows($sql) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($sql)) {
                                $productId = $row['producator_id'];
                                $id = $row['id'];
                                $productName = $row['name'];
                                $productImage = $row['img'];
                                $productRating = $row['rating'];
                                $productPrice = $row['price'];
                                $productProducator = $row['producator'];

                                // Output a table row for each product
                                echo "<tr class='align-middle'>";
                                echo "<td>$productId</td>";
                                echo "<td>$productName</td>";
                                echo "<td><img src='$productImage' alt='Product Image' style='width: 100px; height: 100px; object-fit: contain;'></td>";
                                echo "<td>$productRating</td>";
                                echo "<td>$productPrice</td>";
                                echo "<td>$productProducator</td>";
                                echo "<td>";
                                echo "    <a href='/Eu/Practica/admin/products_crud/delete.php?producator_id=$productId?id=$id'><span class='material-symbols-outlined' style='margin-left: 10px;'>delete</span></a>";
                                echo "    <a href='/Eu/Practica/admin/products_crud/update.php?producator_id=$productId?id=$id'><span class='material-symbols-outlined' style='margin-left: 10px;'>update</span></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
